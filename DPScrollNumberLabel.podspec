#
#  Be sure to run `pod spec lint DPScrollNumberLabel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "DaiPei" => "daipei@hust.edu.cn" }
  ...
  s.source_files  = "DPScrollNumberLabel/*.{h,m}"
  s.public_header_files = "DPScrollNumberLabel/DPScrollNumberLabel.h"
